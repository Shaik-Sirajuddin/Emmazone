...
import com.live.emmazone.databinding.FragmentShopWishListBinding
...
class ShopWishListFragment : LocationUpdateUtilityFragment(),
    ...
    override fun onCreateView(
        ...
        binding = FragmentShopWishListBinding.inflate(layoutInflater)
        clicksHandle()
        return binding.root
    }
